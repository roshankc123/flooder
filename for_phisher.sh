...
email="yo_pro"
pass="hacker"
echo "\e[32m"$hash","$pagename","$randomize","$email","$pass"\e[0m"
echo "curl -o /dev/null -w '%{http_code}' $(cat agent) --request POST --data \"hash=$hash&pagename=$pagename&randomize=$randomize&mima=$email&poussa=$pass\" https://0442ea4.netsolhost.com/wordpress1/BfgqSFS////?f=f1\&l=e\&i=1D4V1D3d361X" > components/RAC/tmp_line
sh components/RAC/tmp_line
